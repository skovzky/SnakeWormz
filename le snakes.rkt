...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |le snakes|) (read-case-sensitive #t) (teachpacks ((lib "batch-io.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "batch-io.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")))))
;====ROBERT HEEMANN====
;----SNAKE GAME----

;========================================================================
;add teachpacks image and universe
;set language to Adnvaced with lambda
;========================================================================
